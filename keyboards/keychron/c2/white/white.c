...
led_config_t g_led_config = {
{
  ...
  {  91,  92,  93,  XX,  XX,  94,  XX,  XX,  XX,  XX,  95,  96,  97,  98,  99, 100, 101, 102,  XX, 103,  XX }
    ...
    { 1 *12, 38 }, { 2 *12, 38 }, { 3 *12, 38 }, { 4 *12, 38 }, { 5 *12, 38 }, { 6 *12, 38 }, { 7 *12, 38 }, { 8 *12, 38 }, { 9 *12, 38 }, { 10*12, 38 }, { 11*12, 38 }, { 12*12, 38 }, { 13*12, 38 }, { 14*12, 38 },                                              { 18*12, 38 }, { 19*12, 38 }, { 20*12, 38 },
    { 1 *12, 51 }, { 2 *12, 51 }, { 3 *12, 51 }, { 4 *12, 51 }, { 5 *12, 51 }, { 6 *12, 51 }, { 7 *12, 51 }, { 8 *12, 51 }, { 9 *12, 51 }, { 10*12, 51 }, { 11*12, 51 }, { 12*12, 51 },                { 14*12, 51 },                { 16*12, 51 },                { 18*12, 51 }, { 19*12, 51 }, { 20*12, 51 }, { 21*12, 51 },
   ...
   B, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, B, B, B, B, 4, 4, 4, 4,
   B, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, B,          4, 4, 4,
   B, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,    B,    4,    4, 4, 4, 4,
